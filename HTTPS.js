...
function getRandomUserAgent() {
    ...
    const countryList = ['US', 'GB', 'FR', 'DE', 'ES', 'UK','BR'];
 ...
 if (process.argv.length < 7){console.log(`node HTTPS.js target time rate thread proxy.txt`); process.exit();}
...
console.log(`------------------------------------------`)
console.log(`Header Method GET+PUT+POST+HEAD`)
console.log(`------------------------------------------`)
console.log(`Methods: HTTPS`)
console.log(`METHOD BY SEC BD`)
console.log(`------------------------------------------`)
